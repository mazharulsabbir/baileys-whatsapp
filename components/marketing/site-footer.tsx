  ...
  return (
    <footer className="site-footer">
      <div className="section-inner footer-grid">
        <div className="footer-brand">
          ...
          <p className="footer-tagline">
            WhatsApp Web connectivity, SSLCommerz billing, and integration APIs — tenant-ready on Node.js.
          </p>
        </div>
      ...
      <div className="footer-bottom section-inner">
        <p className="footer-copy">© {year} Baileys WhatsApp SaaS. All rights reserved.</p>
        <div className="footer-social" aria-label="Social links">
          <a href="https://github.com/WhiskeySockets/Baileys" target="_blank" rel="noreferrer noopener" className="social-link" aria-label="Baileys on GitHub">
